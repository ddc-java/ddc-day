...
In any case, mathematical expressions should rarely be written as plain text, without any typographical distinction from the rest of the content. In particular, mathematical symbols (e.g. Greek letters such as $\pi$ or $\Sigma$, or other symbols or operators such as $\isin$ or $\infty$) should _never_ be "spelled" out in English in the text, unless one or more of these conditions hold:
